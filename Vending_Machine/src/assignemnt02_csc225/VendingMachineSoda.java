...
/**
 * Soda Vending Machine Class that implements both IVendingMachineItems and IVendingMachine methods
 * @author sachin
 */

public class VendingMachineSoda<E> implements IVendingMachineItems, IVendingMachine<IVendingMachineItems>{
    ...
    public VendingMachineSoda(){}
    public VendingMachineSoda(Queue one, Queue two,Queue three){
        itemone=one;
        itemtwo=two;
        itemthree=three;
    }
