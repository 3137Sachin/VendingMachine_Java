...
/**
 * Candy Vending Machine Class that implements both IVendingMachineItems and IVendingMachine methods
 * @author sachin
 */

public class VendingMachineCandy<E> implements IVendingMachineItems, IVendingMachine<IVendingMachineItems>{
    ...
    public VendingMachineCandy(){}
    public VendingMachineCandy(Queue one, Queue two,Queue three){
        itemone=one;
        itemtwo=two;
        itemthree=three;
    }
    ...
    public void TakeMoney(Queue<IVendingMachineItems> oneitem){
        ...
        switch(options.toUpperCase()){
            case "B":
                ...
                givemoney = cash;
                takemoney = oneitem.peek().getPrice();
                ...
                break;
            case "A":
                System.out.println("You have been charged with the following amount from your credit/debit card: " + oneitem.peek().getPrice());
                break;
            default:
